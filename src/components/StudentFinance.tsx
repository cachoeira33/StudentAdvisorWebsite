      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FinanceCard
            ...
            title={t('sfeInfo.tuitionLoan')}
            description={t('sfe.tuitionDesc')}
          />
          <FinanceCard
            icon={<GraduationCap size={32} />}
            title={t('sfeInfo.maintenanceLoan')}
            description={t('sfeInfo.maintenanceDesc')}
          />
          <FinanceCard
            icon={<Calendar size={32} />}
            title={t('sfeInfo.repayment')}
            description={t('sfeInfo.repaymentDesc')}
          />
          <FinanceCard
            icon={<Shield size={32} />}
            title={t('sfeInfo.additional')}
            description={t('sfeInfo.additionalDesc')}
          />
        </div>
      </div>
    </section>
